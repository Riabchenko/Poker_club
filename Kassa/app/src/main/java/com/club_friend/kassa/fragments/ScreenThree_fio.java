...
public class ScreenThree_fio extends Fragment {
    ...
    public static EditText eT_fio;
    public static LinearLayout l_f1,l_f2;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        eT_fio=(EditText)getActivity().findViewById(R.id.eT_fio);

        l_f1=(LinearLayout)getActivity().findViewById(R.id.l_f1);
        l_f2=(LinearLayout)getActivity().findViewById(R.id.l_f2);
